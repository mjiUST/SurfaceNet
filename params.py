...
if whatUWant is "reconstruct_model": 
    ...
    if __use_pretrained_model:
        __layerList_2_loadModel = ["output_SurfaceNet_reshape_linear","output_softmaxWeights"] ##output_fusionNet/fuse_op_reshape
...
#################
    ...
    __modelList_train = [2, 6] if __debug else [2, 6, 7, 8, 14, 16, 18, 19, 20, 22, 30, 31, 36, 39, 41, 42, 44, \
