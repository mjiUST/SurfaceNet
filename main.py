...
if __name__ == "__main__":
    ...
    output_data_rootFld_backup = params.__output_data_rootFld
    if params.whatUWant is 'reconstruct_model':
        for _model in params.__modelList:
            ...
            for N_viewPairs4inference in N_viewPairs4inference_list: # easy to loop through parameters
                for viewList in params.__viewListList:
                    params.__output_data_rootFld = os.path.join(output_data_rootFld_backup, "people/frame{}_views{}".format(params.__frame, viewList))
                    ###############
                    # fix threshold
                    ###############
